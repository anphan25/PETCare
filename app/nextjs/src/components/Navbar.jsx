                ...
                >
                  ...
                  <div className="py-2">
                    {[
                      ...
                      { href: '/wishlist', icon: 'favorite', label: 'My Wishlist' },
                      { href: '/orders', icon: 'history', label: 'Order History' },
                      { href: '/spa-bookings', icon: 'spa', label: 'My Spa Bookings' },
                      { href: '/hotel-bookings', icon: 'hotel', label: 'My Hotel Bookings' },
                    ].map(({ href, icon, label }) => (
                      <Link
                        key={href}
                        href={href}
                      ...
                      >
                        <span className="material-symbols-outlined text-[18px] text-sage">{icon}</span>
                        {label}
                      </Link>
                    ))}
                  </div>
          ...
          >
            <div className="flex flex-col gap-3 pt-4 pb-2">
              {[...navItems,
                ...
                { to: '/spa-bookings', label: 'My Spa Bookings' },
                { to: '/hotel-bookings', label: 'My Hotel Bookings' },
              ].map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`px-4 py-2 rounded-xl transition-colors ${
                      isActive ? 'bg-sage/20 text-sage-dark font-semibold' : 'text-surface-variant hover:text-sage-dark'
                    }`}
                  >
                    {item.label}
                  </Link>
